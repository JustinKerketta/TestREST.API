...
\item
\textbf{Routable Pages}: If you include pages with @page directives in the RCL, you must tell the Blazor Router where to find them by adding the library's assembly to the AdditionalAssemblies parameter in App.razor or Routes.razor.
\item
